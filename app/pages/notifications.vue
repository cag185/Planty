    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
      ...
      <div class="flex items-center justify-between mb-8">
        <div>
          ...
          <p class="text-text-secondary mt-1">{{ store.unreadCount }} unread</p>
        </div>
        <div class="flex gap-2" v-if="store.notifications.length > 0">
          <button
      ...
      <template v-else>
        ...
        <div v-if="store.requirementNotifications.length > 0" class="mb-10">
          <h2
          ...
          <div class="space-y-3">
            <div
              v-for="n in store.requirementNotifications"
              :key="n.id"
              ...
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <div class="flex gap-2 mt-3">
                    <button
                      v-if="!n.completed"
                      @click="store.markCompleted(n.id)"
        ...
        <div v-if="store.autonomousNotifications.length > 0">
          <h2
            class="text-sm font-semibold text-text-secondary uppercase tracking-wider mb-4"
          >
            Autonomous Updates
          ...
          <div class="space-y-3">
            <div
              v-for="n in store.autonomousNotifications"
              :key="n.id"
              class="rounded-2xl p-5 border transition-all"
              :class="
                n.read
